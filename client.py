...
class STAPIClient:
    ...
    def classify_image(self, image: Image.Image, image_format: str = "PNG") -> ClassificationResult:
        ...
        try:
            ...
            if response.status_code != 200:
                ...
                raise STAPIError(error_msg, response.status_code, response.json() if response.content else None)
            ...
            try:
                ...
                raise STAPIError(f"Failed to parse API response: {e}", response.status_code, None)
    ...
    def health_check(self) -> HealthStatus:
        ...
        try:
            ...
            if response.status_code != 200:
                raise STAPIError(f"Health check failed with status {response.status_code}", response.status_code)
